...
class ParallelSARDecoder(BaseDecoder):
    ...
    def __init__(self,
        ...
        self.conv1x1_1 = nn.Linear(decoder_rnn_out_size, d_k) #(512,64)
    ...
    def _2d_attention(self,
        ...
        attn_query = attn_query.view(bsz, seq_len, attn_size, 1, 1) #sz * (seq_len + 1) * attn_size 1 1 (24 31 64 1 1)
         
        attn_key = self.conv3x3_1(feat)
        # bsz * attn_size * h * w
        attn_key = attn_key.unsqueeze(1)
        # bsz * 1 * attn_size * h * w
        attn_weight = torch.tanh(torch.add(attn_key, attn_query, alpha=1)) #torch.Size([24, 31, 512, 6, 64])
