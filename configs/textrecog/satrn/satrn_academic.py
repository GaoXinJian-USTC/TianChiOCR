...
test_img_prefix1 = test_prefix + 'IIIT5K/test'
test_img_prefix2 = test_prefix + 'SVT/image'
# test_img_prefix3 = test_prefix + 'icdar_2013/'
# test_img_prefix4 = test_prefix + 'icdar_2015/'
test_img_prefix5 = test_prefix + 'SVTP/IMG'
test_img_prefix6 = test_prefix + 'CUTE80/CUTE80'
...
test_ann_file6 = test_prefix + 'CUTE80/test_label.txt'
